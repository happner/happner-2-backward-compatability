...
describe('7 - test persisted config, check memory and persisted data stores', function () {
  ...
  it('tests storing data routed to mem', function (done) {
    ...
    try {
      ...
      testClient.exchange.DataComponent7.storeData('stuff/this/thing', {'test': 'data'}, function (e, response) {
  ...
  it('tests storing data routed to persist', function (done) {
    ...
    try {
      ...
      testClient.exchange.DataComponent7.storeData('things/with/roman', {'test': 'xata'}, function (e, response) {
  ...
  it('tests storing data routed to mem, in the data component', function (done) {
    ...
    try {
      ...
      testClient.exchange.data.set('stuff/this/thing', {'test': 'data'}, function (e, response) {
  ...
  it('tests storing data routed to persist, in the data component', function (done) {
    ...
    try {
      ...
      testClient.exchange.data.set('things/with/roman', {'test': 'xata'}, function (e, response) {
